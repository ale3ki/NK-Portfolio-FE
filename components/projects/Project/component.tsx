                        ...
                        <div className={`${styles['firstCol']} col-11 col-lg-6`}>
                            ...
                            <div className={styles.progsUsed}>
                                ...
                                <Fade direction='left' triggerOnce>
                                    <img className={`${styles['myBtmLeftImg']} img-fluid`} src={data?.imageBLeft ? (data.imageBLeft + data.blobLinkAppend!) : ""} alt="Image Not Found" />
                                </Fade>
                            </div>
                        </div>
                        <div className={`${styles['mySecondCol']} col-12 col-lg-6 container`}>
                            <Fade direction='right' triggerOnce>
                                <img className={`${styles['myBtmRightImg']} img-fluid`} src={data?.imageMidRight ? (data.imageMidRight + data.blobLinkAppend!) : ""} alt="Image Not Found" />
                            </Fade>
                        </div>
                    </div>
                </div>
